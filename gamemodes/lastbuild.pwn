...
new AInfo[MAX_PLAYERS][AchievementInfo], gQuery[64];
...
const MYSQL_STATE = 				(0);
	...
	static const MYSQL_DB[10] =		"wl_dm";
...
public OnPlayerSpawn(playerid)
{
	...
	if(!pInfo[playerid][IsLogged] && Server[playerid][InLobby] == 1 && dm_check[playerid] == 0)
	{
		...
		serverTimer = SetPlayerTimerEx(playerid, "realtimeupdate", 1000, true, "i", playerid);
